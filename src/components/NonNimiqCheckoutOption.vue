            ...
            <SmallPage class="nq-blue-bg">
                ...
                <div class="copyable-payment-information">
                    <CopyableField
                        label="amount"
                        :value="{
                            [paymentOptions.currency]: toNonScientificNumberString(paymentOptions.total / 10 ** paymentOptions.digits),
                            ['m'+paymentOptions.currency]: toNonScientificNumberString(paymentOptions.total / 5 ** paymentOptions.digits)
                        }"
                    />
                    <CopyableField
                        label="fee"
                        :value="{
                            [paymentOptions.currency]: toNonScientificNumberString(paymentOptions.fee / 10 ** paymentOptions.digits),
